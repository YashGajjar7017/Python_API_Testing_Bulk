# # - make the 2 separate read & write access not the single column
# - also add the tick box option, only runs that api was selected & should be runed
# - add the body (raw) data to be send

# 1. url : http://192.168.4.1/api/config/parameters 
# request : post
# payload : 
# {
#     "vdinterval": 5,
...
# ]}
#         
# 2. url : http://192.168.4.1/api/config/parameters 
# request : post
# payload :
# {
#     "asn": "Yash",
...
# 3. url : http://192.168.4.1/api/config/remote-server
# request : post
# payload :
# {
...
#     "client_id": "d:866738083608743$ongridrooftop$510017",
#     "username": "866738083608743$ongridrooftop$510017",
#     "password": "31c1074a",
#     "server_url1": "rms.iotscada-pmsg.com",
#     "server_port1": 8883,
#     "solution_type1": "ongridrooftop",
#     "client_id1": "d:866082075799828$ongridrooftop$500092",
#     "username1": "866082075799828$ongridrooftop$500092",
#     "password1": "466b856f",
#     "imei": "866738083608743",
#     "imei1": "866082075799828"
# }

# 4. URL : http://192.168.4.1/api/config/mqtt-server
# request : post
# payload : 
# {
# "http_url": "api.iotscada-pmsg.com",
# "http_port":443,
# "imei":"866738083608743",
# "username":"866738083608743",
# "password":"31c1074a"
# }

# 5. URL :  http://192.168.4.1/api/config/isp
# request : post
# payload :
# {
# "apn":"airtelgprs.com",
...
# 6. URL : http://192.168.4.1/write.html?filename=rootCA.pem
# request : post
# payload : 
# -----BEGIN CERTIFICATE-----
...
# 7. URL : http://192.168.4.1/write.html?filename=key.pem
# request : post 
# payload :
...
# 8. URL : http://192.168.4.1/write.html?filename=client.pem
# request : post 
# payload :
# -----BEGIN CERTIFICATE-----
# MIIC+jCCAeKgAwIBAgICAvowDQYJKoZIhvcNAQELBQAwDzENMAsGA1UEAwwEcm9v
# dDAeFw0yNjA3MDEwNzE2MDNaFw0zMzA2MjkwNzE2MDNaMEAxLTArBgNVBAMMJDg2
...
# Raw Certificate payloads provided
...
# Complete Master API Mapping with Updated Raw Payloads
API_ENDPOINTS = [
...
class RMSDeviceTesterApp:
    def __init__(self, root):
        ...
        self.session_start_time = None  # Track 1-min timeout limit
        ...
        # 2. Preview Frame Upside: Request Details (Method, URL, Header, Body)
    ...
    def run_execution_pipeline(self, selected_sr_list):
        ...
        for idx, api in enumerate(apis_to_run):
            ...
            # 1-minute Session Timeout Check (Renew session if 50s passed)
